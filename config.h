...
static char *fonts[]          = { "monospace:size=12", "NotoColorEmoji:pixelsize=18:antialias=true:autohint=true"  };
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "70x18", NULL };
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "30x10", "-e", "bc", "-lq", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,		XK_s,		spawn,		{.v = (const char*[]){ "screencast", NULL } } },
	{ MODKEY|ControlMask,		XK_w,		spawn,		{.v = (const char*[]){ "camcast", NULL } } },
	{ MODKEY|ShiftMask,		XK_s,		spawn,		{.v = (const char*[]){ "dmenurecord", "kill", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_n,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "nvim", "-c", "Ex", NULL } } },
	...
	{ MODKEY,			XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#' ~/Notes/snippets | dmenu -i -l 50 | cut -d' ' -f1)") },
