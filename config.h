...
static const unsigned int baralpha = 236;
...
/*  { MODKEY|ShiftMask,                 XK_grave,       togglescratch, SHCMD("") }, */
    ...
    { Mod1Mask,                         XK_space,       spawn,         SHCMD("/home/cf/.local/bin/kb-toggle")},
...
*/
    ...
    /* Délégation de l'avaleur à l'avalée des avalés */
    { MODKEY | ShiftMask,    XK_apostrophe,  swalstopsel,     {0}},
    { MODKEY | ShiftMask,    XK_p,           spawn,           SHCMD("unswal 1")},
    { ControlMask,           XK_space,       spawn,           SHCMD("unswal 1")},
    { MODKEY,                XK_x,           spawn,           SHCMD("unswal 1")},

/*  { ControlMask,           XK_x,           spawn,           SHCMD("unswal 1")},   */
/*  { MODKEY,                XK_h,           spawn,           SHCMD("unswal 1")},   */
/*  { MODKEY|ShiftMask,      XK_j,           spawn,           SHCMD("unswal 1")},   */

    /* ctrl +  homer jr. kool leo swallow  */
    ...
    /* Déplacement des fenêtres dans la stack */
    { MODKEY,               XK_Page_Up,      shiftview,      {.i = -1}},
    { MODKEY | ShiftMask,   XK_Page_Up,      shifttag,       {.i = -1}},
    { MODKEY,               XK_Page_Down,    shiftview,      {.i = +1}},
    { MODKEY | ShiftMask,   XK_Page_Down,    shifttag,       {.i = +1}},

    /* Super + fonctions === Dompe de vieux scripts sales  */
    ...
    /* Touches de fonctions; certaines n'ont pas les fonctions attendus par défaut..  à tester... */
