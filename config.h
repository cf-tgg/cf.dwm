...
static const Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_Tab, spawn,
    ...
    {MODKEY | ControlMask,
     XK_s,
     spawn,
     {.v = (const char *[]){"screencast", NULL}}},
    {MODKEY | ControlMask,
     XK_w,
     spawn,
     {.v = (const char *[]){"camcast", NULL}}},
    {MODKEY | ShiftMask,
     XK_s,
     spawn,
     {.v = (const char *[]){"dmenurecord", "kill", NULL}}},
    {MODKEY, XK_Up, spawn,
     SHCMD("xdotool type \"$(grep -v '^#' ~/Notes/bmcmd | dmenu -i -l 50 | cut "
           "-d' ' -f2-)\"")},
    ...
    {MODKEY | ShiftMask,
     XK_b,
     spawn,
     {.v = (const char *[]){"bookmarkthis", NULL}}},
    {MODKEY | ShiftMask,
     XK_n,
     spawn,
     {.v = (const char *[]){TERMINAL, "-e", "nvim", "-c", "Ex", NULL}}},
    {MODKEY, XK_n, spawn,
    ...
    {MODKEY | ControlMask, XK_Right, spawn,
     SHCMD("xrandr --output eDP-1 --rotate left && setbg")},
    {MODKEY | ControlMask, XK_Left, spawn,
     SHCMD("xrandr --output eDP-1 --rotate right && setbg")},
    {MODKEY | ControlMask, XK_Up, spawn,
     SHCMD("xrandr --output eDP-1 --rotate inverted && setbg")},
    ...
    {MODKEY | ShiftMask, XK_s, spawn,
     SHCMD("xdotool type $(grep -v '^#' ~/Notes/snippets | dmenu -i -l 50 | "
           "cut -d' ' -f1)")},
    {MODKEY | ShiftMask, XK_Insert, spawn,
     SHCMD("xdotool type --delay 50 \"$(grep -v '^#' ~/Notes/bmcmd | dmenu -i "
           "-l 50 | cut -d' ' -f2-)\"")},
    {MODKEY, XK_F1, spawn,
     SHCMD("man -k . | dmenu -l 30 | awk '{print $1}' | xargs -r man -Tpdf | "
           "zathura -")},
 ...
 */
    ...
    /*{ ClkClientWin,		MODKEY,		Button4,	incrgaps,
       {.i = +1} },*/
    /*{ ClkClientWin,		MODKEY,		Button5,	incrgaps,
       {.i = -1} },*/
